...
3. Também é possível acessar a API através do Swagger, para isso basta clicar nesse [link](http://18.232.136.120/swagger-ui/index.html) e acessar a documentação 
